...
#
## Ex: util_find_sub_module_file_path 'tool' 'conf-set'
## Path: sub/on/tool/func/conf-set.sh
...
## Ex: util_load_sub_module 'tool' 'conf-set'
...
## Ex: util_run_sub_module_function 'tool' 'conf-set' 'tool_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/tool/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'tool' 'install'
## Path: sub/tool/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'tool' 'install' 'main'
## Path: sub/tool/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'tool' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'tool' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'tool'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "tool"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'tool'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'tool' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "tool"
