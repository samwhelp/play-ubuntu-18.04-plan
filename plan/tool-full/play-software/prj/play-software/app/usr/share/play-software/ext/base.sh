...
is_debug () {
	if [ "$DEBUG_PLAY_SOFTWARE" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	THE_PLAN_NAME="play-software"
	THE_PRJ_NAME="$THE_PLAN_NAME"
	THE_MAIN_CMD_NAME="mod-software"


	THE_PLAN_DIR_PATH=$(find_dir_path "$THE_BASE_DIR_PATH/../.") ## /usr/share/play-software


	THE_BIN_DIR_NAME="bin"
	THE_BIN_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_BIN_DIR_NAME" ## /usr/share/play-software/bin

	THE_EXT_DIR_NAME="ext"
	THE_EXT_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_EXT_DIR_NAME" ## /usr/share/play-software/ext


	THE_SUB_DIR_NAME="sub"
	THE_SUB_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_SUB_DIR_NAME" ## /usr/share/play-software/sub

	THE_SUB_ON_DIR_NAME="on"
	THE_SUB_ON_DIR_PATH="$THE_SUB_DIR_PATH/$THE_SUB_ON_DIR_NAME" ## /usr/share/play-software/sub/on

	THE_SUB_ALL_DIR_NAME="all"
	THE_SUB_ALL_DIR_PATH="$THE_SUB_DIR_PATH/$THE_SUB_ALL_DIR_NAME" ## /usr/share/play-software/sub/all
