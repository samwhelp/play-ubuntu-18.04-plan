...
#
## Ex: util_find_sub_module_file_path 'software' 'conf-set'
## Path: sub/on/software/func/conf-set.sh
...
## Ex: util_load_sub_module 'software' 'conf-set'
...
## Ex: util_run_sub_module_function 'software' 'conf-set' 'software_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/software/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'software' 'install'
## Path: sub/software/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'software' 'install' 'main'
## Path: sub/software/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'software' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'software' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'software'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "software"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'software'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'software' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "software"
