...
#
## Ex: util_find_sub_module_file_path 'apt' 'conf-set'
## Path: sub/on/apt/func/conf-set.sh
...
## Ex: util_load_sub_module 'apt' 'conf-set'
...
## Ex: util_run_sub_module_function 'apt' 'conf-set' 'apt_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/apt/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'apt' 'install'
## Path: sub/apt/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'apt' 'install' 'main'
## Path: sub/apt/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'apt' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'apt' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'apt'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "apt"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'apt'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'apt' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "apt"
