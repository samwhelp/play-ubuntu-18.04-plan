...
is_debug () {
	if [ "$DEBUG_PLAY_LOCALE" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	THE_PLAN_NAME="play-locale"
	THE_PRJ_NAME="$THE_PLAN_NAME"
	THE_MAIN_CMD_NAME="mod-locale"


	THE_PLAN_DIR_PATH=$(find_dir_path "$THE_BASE_DIR_PATH/../.") ## /usr/share/play-locale


	THE_BIN_DIR_NAME="bin"
	THE_BIN_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_BIN_DIR_NAME" ## /usr/share/play-locale/bin

	THE_EXT_DIR_NAME="ext"
	THE_EXT_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_EXT_DIR_NAME" ## /usr/share/play-locale/ext


	THE_SUB_DIR_NAME="sub"
	THE_SUB_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_SUB_DIR_NAME" ## /usr/share/play-locale/sub

	THE_SUB_ON_DIR_NAME="on"
	THE_SUB_ON_DIR_PATH="$THE_SUB_DIR_PATH/$THE_SUB_ON_DIR_NAME" ## /usr/share/play-locale/sub/on

	THE_SUB_ALL_DIR_NAME="all"
	THE_SUB_ALL_DIR_PATH="$THE_SUB_DIR_PATH/$THE_SUB_ALL_DIR_NAME" ## /usr/share/play-locale/sub/all
