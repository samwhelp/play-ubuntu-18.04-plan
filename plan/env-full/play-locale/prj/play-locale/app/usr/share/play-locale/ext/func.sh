...
$ $THE_MAIN_CMD_NAME sub:locale_gen/all

$ $THE_MAIN_CMD_NAME sub:locale_switch/en_us
$ $THE_MAIN_CMD_NAME sub:locale_switch/zh_tw
...
#
## Ex: util_find_sub_module_file_path 'locale' 'conf-set'
## Path: sub/on/locale/func/conf-set.sh
...
## Ex: util_load_sub_module 'locale' 'conf-set'
...
## Ex: util_run_sub_module_function 'locale' 'conf-set' 'locale_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/locale/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'locale' 'install'
## Path: sub/locale/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'locale' 'install' 'main'
## Path: sub/locale/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'locale' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'locale' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'locale'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "locale"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'locale'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'locale' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "locale"
