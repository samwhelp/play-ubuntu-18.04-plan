...
#
## Ex: util_find_sub_module_file_path 'font' 'conf-set'
## Path: sub/on/font/func/conf-set.sh
...
## Ex: util_load_sub_module 'font' 'conf-set'
...
## Ex: util_run_sub_module_function 'font' 'conf-set' 'font_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/font/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'font' 'install'
## Path: sub/font/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'font' 'install' 'main'
## Path: sub/font/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'font' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'font' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'font'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "font"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'font'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'font' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "font"
