...
$ $THE_MAIN_CMD_NAME sub:gcin/install
$ $THE_MAIN_CMD_NAME sub:gcin/remove
$ $THE_MAIN_CMD_NAME sub:gcin/pkg-install
$ $THE_MAIN_CMD_NAME sub:gcin/pkg-remove
$ $THE_MAIN_CMD_NAME sub:gcin/conf-set
$ $THE_MAIN_CMD_NAME sub:gcin/conf-reset

$ $THE_MAIN_CMD_NAME sub:hime/install
$ $THE_MAIN_CMD_NAME sub:hime/remove
$ $THE_MAIN_CMD_NAME sub:hime/pkg-install
$ $THE_MAIN_CMD_NAME sub:hime/pkg-remove
$ $THE_MAIN_CMD_NAME sub:hime/conf-set
$ $THE_MAIN_CMD_NAME sub:hime/conf-reset

$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/install
$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/remove
$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/pkg-install
$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/pkg-remove
$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/conf-set
$ $THE_MAIN_CMD_NAME sub:fcitx_chewing/conf-reset

$ $THE_MAIN_CMD_NAME sub:ibus_chewing/install
$ $THE_MAIN_CMD_NAME sub:ibus_chewing/remove
$ $THE_MAIN_CMD_NAME sub:ibus_chewing/pkg-install
$ $THE_MAIN_CMD_NAME sub:ibus_chewing/pkg-remove
$ $THE_MAIN_CMD_NAME sub:ibus_chewing/conf-set
$ $THE_MAIN_CMD_NAME sub:ibus_chewing/conf-reset
...
#
## Ex: util_find_sub_module_file_path 'im' 'conf-set'
## Path: sub/on/im/func/conf-set.sh
...
## Ex: util_load_sub_module 'im' 'conf-set'
...
## Ex: util_run_sub_module_function 'im' 'conf-set' 'im_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/im/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'im' 'install'
## Path: sub/im/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'im' 'install' 'main'
## Path: sub/im/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'im' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'im' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'im'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "im"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'im'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'im' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "im"
