...
xdg_dir_prepare () {
	...
	echo mkdir -p "$THE_PCMANFM_QT_LXQT_CONF_MAIN_DIR_PATH"
	mkdir -p "$THE_PCMANFM_QT_LXQT_CONF_MAIN_DIR_PATH"

	## $HOME/.config/pcmanfm-qt/default
	echo mkdir -p "$THE_PCMANFM_QT_DEFAULT_CONF_MAIN_DIR_PATH"
	mkdir -p "$THE_PCMANFM_QT_DEFAULT_CONF_MAIN_DIR_PATH"


	## $HOME/.config/xfce4/xfconf/xfce-perchannel-xml
	echo mkdir -p "$THE_XFCE4_XFCONF_XFCE_PERCHANNEL_CONF_MAIN_DIR_PATH"
	mkdir -p "$THE_XFCE4_XFCONF_XFCE_PERCHANNEL_CONF_MAIN_DIR_PATH"
