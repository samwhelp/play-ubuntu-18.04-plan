...
#
## Ex: util_find_sub_module_file_path 'i3' 'conf-set'
## Path: sub/on/i3/func/conf-set.sh
...
## Ex: util_load_sub_module 'i3' 'conf-set'
...
## Ex: util_run_sub_module_function 'i3' 'conf-set' 'i3_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/i3/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'i3' 'install'
## Path: sub/i3/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'i3' 'install' 'main'
## Path: sub/i3/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'i3' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'i3' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'i3'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "i3"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'i3'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'i3' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "i3"
