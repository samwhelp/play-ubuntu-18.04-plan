...
#
## Ex: util_find_sub_module_file_path 'gnome' 'conf-set'
## Path: sub/on/gnome/func/conf-set.sh
...
## Ex: util_load_sub_module 'gnome' 'conf-set'
...
## Ex: util_run_sub_module_function 'gnome' 'conf-set' 'gnome_conf_set'
...
#
## Ex: util_app_install_run_each_sub 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_app_remove_run_each_sub 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
### Head: util_conf_set ########################################################
#
## Ex: util_conf_set_run_each_sub 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
## Ex: util_conf_reset_run_each_sub 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
#
# Ex: util_load_package_list_file 'sub/gnome/pkg/install/main.txt'
...
## Ex: util_find_sub_package_dir_path 'gnome' 'install'
## Path: sub/gnome/pkg/install
...
## Ex: util_find_sub_package_list_file_path 'gnome' 'install' 'main'
## Path: sub/gnome/pkg/install/main.txt
...
## Ex: util_load_sub_package_list 'gnome' 'install' 'main'
...
## Ex: util_load_type_sub_package_list 'gnome' 'install'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path 'gnome'
...
## Ex: util_pkg_install_find_sub_package_list_dir_path_list 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_install_find_sub_package_list_name_list "gnome"
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path 'gnome'
...
## Ex: util_pkg_remove_find_sub_package_list_dir_path_list 'gnome' 'rofi' 'fcitx' 'gtk3' 'gtk2'
...
## Ex: util_pkg_remove_find_sub_package_list_name_list "gnome"
