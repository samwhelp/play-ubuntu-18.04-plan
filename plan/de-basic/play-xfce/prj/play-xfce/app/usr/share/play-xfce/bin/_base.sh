...
base_var_init () {
	...
	THE_DOCUMENTROOT_DIR_PATH="$THE_PLAN_DIR_PATH" ## /usr/share/play-xfce

	THE_BIN_DIR_NAME="bin"
	THE_BIN_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_BIN_DIR_NAME" ## /usr/share/play-xfce/bin

	THE_VAR_DIR_NAME="var"
	THE_VAR_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_VAR_DIR_NAME" ## /usr/share/play-xfce/var

	THE_ENV_DIR_NAME="env"
	THE_ENV_DIR_PATH="$THE_VAR_DIR_PATH/$THE_ENV_DIR_NAME" ## /usr/share/play-xfce/var/env

	THE_ENV_DEFAULT_PROFILE="default"
	THE_ENV_DEFAULT_PROFILE_DIR_NAME="$THE_ENV_DEFAULT_PROFILE"
	THE_ENV_DEFAULT_PROFILE_DIR_PATH="$THE_ENV_DIR_PATH/$THE_ENV_DEFAULT_PROFILE_DIR_NAME" ## /usr/share/play-xfce/var/env/default

	THE_ENV_USE_FILE_NAME=".use"
	THE_ENV_USE_FILE_PATH="$THE_ENV_DIR_PATH/$THE_ENV_USE_FILE_NAME" ## /usr/share/play-xfce/var/env/.use

	THE_ITF_DIR_NAME="itf"
	THE_ITF_DIR_PATH="$THE_VAR_DIR_PATH/$THE_ITF_DIR_NAME" ## /usr/share/play-xfce/var/itf

	THE_XDG_CONFIG_DIR_NAME=".config"
	THE_XDG_CONFIG_DIR_PATH="$HOME/$THE_XDG_CONFIG_DIR_NAME" ## ~/.config

	THE_PRJ_CONFIG_DIR_PATH="$THE_XDG_CONFIG_DIR_PATH/$THE_PRJ_NAME" ## ~/.config/play-xfce
	THE_ENV_USER_DIR_PATH="$THE_PRJ_CONFIG_DIR_PATH/$THE_ENV_DIR_NAME" ## ~/.config/play-xfce/env

	THE_ENV_USER_DEFAULT_DIR_NAME="$THE_ENV_DEFAULT_PROFILE_DIR_NAME"
	THE_ENV_USER_DEFAULT_DIR_PATH="$THE_ENV_USER_DIR_PATH/$THE_ENV_USER_DEFAULT_DIR_NAME" ## ~/.config/play-xfce/env/default

	THE_ENV_USER_USE_FILE_NAME="$THE_ENV_USE_FILE_NAME"
	THE_ENV_USER_USE_FILE_PATH="$THE_ENV_USER_DIR_PATH/$THE_ENV_USER_USE_FILE_NAME" ## ~/.config/play-xfce/env/.use



	THE_PKG_LIST_FILE_NAME="pkg-main.list.txt"
	THE_PKG_LIST_FILE_PATH="$THE_ITF_DIR_PATH/$THE_PKG_LIST_FILE_NAME" ## /usr/share/play-xfce/var/itf/pkg-main.list.txt

	THE_CONF_DIR_NAME="conf"
	THE_CONF_DIR_PATH="$THE_VAR_DIR_PATH/$THE_CONF_DIR_NAME" ## /usr/share/play-xfce/var/conf
	...
	THE_XFCE4_PANEL_CONF_SET_DIR_NAME="panel"
	THE_XFCE4_PANEL_CONF_SET_DIR_PATH="$THE_XFCE4_CONF_SET_DIR_PATH/$THE_XFCE4_PANEL_CONF_SET_DIR_NAME" ## /usr/share/play-xfce4/var/conf/xfce4.set/panel

	THE_XFCE4_PANEL_CONF_MAIN_DIR_NAME="panel"
	THE_XFCE4_PANEL_CONF_MAIN_DIR_PATH="$THE_XFCE4_CONF_MAIN_DIR_PATH/$THE_XFCE4_PANEL_CONF_MAIN_DIR_NAME" ## ~/.config/xfce4/panel


	THE_ROFI_CONF_SET_DIR_NAME="rofi.set"
	THE_ROFI_CONF_SET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_ROFI_CONF_SET_DIR_NAME" ## /usr/share/play-xfce/var/conf/rofi.set

	THE_ROFI_CONF_RESET_DIR_NAME="rofi.reset"
	THE_ROFI_CONF_RESET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_ROFI_CONF_RESET_DIR_NAME" ## /usr/share/play-xfce/var/conf/rofi.reset
	...
	THE_FCITX_CONF_SET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_FCITX_CONF_SET_DIR_NAME" ## /usr/share/play-xfce/var/conf/fcitx.set

	THE_FCITX_CONF_RESET_DIR_NAME="fcitx.reset"
	THE_FCITX_CONF_RESET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_FCITX_CONF_RESET_DIR_NAME" ## /usr/share/play-xfce/var/conf/fcitx.reset
	...
	THE_GTK3_CONF_SET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_GTK3_CONF_SET_DIR_NAME" ## /usr/share/play-xfce/var/conf/gtk3.set

	THE_GTK3_CONF_RESET_DIR_NAME="gtk3.reset"
	THE_GTK3_CONF_RESET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_GTK3_CONF_RESET_DIR_NAME" ## /usr/share/play-xfce/var/conf/gtk3.reset
	...
	THE_GTK2_CONF_SET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_GTK2_CONF_SET_DIR_NAME" ## /usr/share/play-xfce/var/conf/gtk2.set

	THE_GTK2_CONF_RESET_DIR_NAME="gtk2.reset"
	THE_GTK2_CONF_RESET_DIR_PATH="$THE_CONF_DIR_PATH/$THE_GTK2_CONF_RESET_DIR_NAME" ## /usr/share/play-xfce/var/conf/gtk2.reset
...
base_var_dump () {
	...
	echo "THE_XFCE4_PANEL_CONF_SET_DIR_NAME=$THE_XFCE4_PANEL_CONF_SET_DIR_NAME"
	echo "THE_XFCE4_PANEL_CONF_SET_DIR_PATH=$THE_XFCE4_PANEL_CONF_SET_DIR_PATH"

	echo "THE_XFCE4_PANEL_CONF_MAIN_DIR_NAME=$THE_XFCE4_PANEL_CONF_MAIN_DIR_NAME"
	echo "THE_XFCE4_PANEL_CONF_MAIN_DIR_PATH=$THE_XFCE4_PANEL_CONF_MAIN_DIR_PATH"
