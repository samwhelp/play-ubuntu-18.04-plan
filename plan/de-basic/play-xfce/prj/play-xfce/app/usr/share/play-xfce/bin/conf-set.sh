...
run_xfce4_conf_set_each_panel () {
	run_conf_set_each "$THE_XFCE4_PANEL_CONF_SET_DIR_PATH" "$THE_XFCE4_PANEL_CONF_MAIN_DIR_PATH" "$@"
}

run_xfce4_conf_set () {
	local file_list="xfce4-keyboard-shortcuts.xml xfwm4.xml xfce4-panel.xml xfce4-desktop.xml keyboards.xml xsettings.xml"

	run_xfce4_conf_set_each "$file_list"

	#file_list="whiskermenu-1.rc launcher-9/15206938821.desktop"
	file_list="whiskermenu-1.rc"

	run_xfce4_conf_set_each_panel "$file_list"
