...
tint2_config_install () {
	...
	mkdir -p "$HOME/.config/spectrwm/tint2"
	echo "mkdir -p $HOME/.config/spectrwm/tint2"

	cp "./config/tint2/tint2rc" "$HOME/.config/spectrwm/tint2/tint2rc"
	echo "cp ./config/tint2/tint2rc $HOME/.config/spectrwm/tint2/tint2rc"
