...
compton_config_install () {
	...
	cp "/usr/share/doc/compton/examples/compton.sample.conf" "$HOME/.config/i3/compton/compton.conf"
	echo "cp /usr/share/doc/compton/examples/compton.sample.conf $HOME/.config/i3/compton/compton.conf"
}
##
### Tail: compton
################################################################################
