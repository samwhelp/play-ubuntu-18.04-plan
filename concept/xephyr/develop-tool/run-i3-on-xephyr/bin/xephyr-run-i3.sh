...
__main__ () {
	...
	## $ dpkg -L i3-wm | grep xsession | grep 'i3.desktop'
	## /usr/share/xsessions/i3.desktop
	## $ grep '^Exec=' /usr/share/xsessions/i3.desktop
	## $ grep '^Exec=' $(dpkg -L i3-wm | grep xsession | grep 'i3.desktop')
	## Exec=i3
	## $ which i3
	## /usr/bin/i3

	## run i3
	#DISPLAY=:100 /usr/bin/i3
	DISPLAY=:100 i3
